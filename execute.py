...
from Med_data_helper import load_train_data, load_test_data, load_embedding, batch_iter
from polymerization import LSTM_QA


#------------------------- define parameter -----------------------------
#  第一个是参数名称，第二个参数是默认值，第三个是参数描述
tf.flags.DEFINE_string("train_file", "../train_file.csv", "train corpus file")
tf.flags.DEFINE_string("test_file", "../testFile.csv", "test corpus file")
tf.flags.DEFINE_string("valid_file", "../valid_File.csv", "test corpus file")
tf.flags.DEFINE_string("embedding_file", "../dic4.txt", "embedding file")
...
tf.flags.DEFINE_integer("batch_size", 100, "batch size of each batch")  # 100调整到30
...
tf.flags.DEFINE_integer("num_unroll_steps", 100, "embedding size")  # 句子截取字的个数
